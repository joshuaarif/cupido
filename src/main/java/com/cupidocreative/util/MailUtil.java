...
public class MailUtil {
	 ...
	 */
	public MimeMessage createTextEmail(String to, String from, String subject, String bodyText)
			throws MessagingException {
	...
	public MimeMessage createHtmlEmail(String to, String from, String subject, String htmlBodyText)
			throws MessagingException {
		Properties props = new Properties();
		Session session = Session.getDefaultInstance(props, null);
		...
		mimeBodyPart.setContent(htmlBodyText, "text/html");
